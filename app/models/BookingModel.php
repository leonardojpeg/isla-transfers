...
class BookingModel{
    ...
    public function addReturnBooking($uuid, $dateFly, $timeFly, $flyNumer, $pickupTime, $hotelSelect, $carSelect, $passengerNum, $email, $reserveType){
        global $pdo;

        $query = "
                INSERT INTO transfer_reservas (id_tipo_reserva, localizador, email_cliente, fecha_vuelo_salida, hora_vuelo_salida, numero_vuelo_entrada, hora_recogida_salida, id_destino, num_viajeros, id_vehiculo)
                VALUES
                (:tipo_reserva, :localizador, :email_cliente, :fecha_vuelo_salida, :hora_vuelo_salida, :numero_vuelo_entrada, :hora_recogida_salida, :id_destino, :num_viajeros, :id_vehiculo)";

...
<!-- Modal -->
<div class="modal fade" id="editReturnModal" tabindex="-1" aria-labelledby="customerModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="index.php?page=customerPanel" method="POST">
                    <input type="hidden" name="submitEditReturnReservation" value="1">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="uuid" class="form-label">Localizador</label>
                            <input type="text" id="ruuid" name="uuid" class="form-control" readonly>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="dateFly" id="rdateFly" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label for="timeFly" class="form-label">Hora del vuelo</label>
                            <input type="time" name="timeFly" id="rtimeFly" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="pickupTime" class="form-label">Hora de recogida</label>
                            <input type="time" name="pickupTime" id="rpickupTime" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <?php
                            global $pdo;
                            ...
                            <select class="form-select" name="hotelSelect" id="rhotelSelect">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="passengerNum" id="rpassengerNum" class="form-control" required min="1">
                        </div>
                        <div class="col-md-6">
                            <?php
                            ...
                            <select class="form-select" name="carSelect" id="rcarSelect">
                                <option selected>Selecionar...</option>
                                <?php while ($row_fleet = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>

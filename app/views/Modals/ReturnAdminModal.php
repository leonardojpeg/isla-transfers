...
<!-- Modal -->
<div class="modal fade" id="returnAdminModal" tabindex="-1" aria-labelledby="customerModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="index.php?page=adminPanel" method="POST">
                    <input type="hidden" name="submitReturnAdminReservation" value="1">
                    <div class="row mb-3">
                        <div class="col-md-6">
